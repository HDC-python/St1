...
with tab1:
    ...
    st.markdown(
    """
    Ingénieur civil architecte avec une expérience en bureaux d'études et une riche expértise sur le terrain en tant que charpentier et ferronnier. J'ai suivi un parcours atypique où mes intérêts privés nourrissent ma carrière. Du dévelloppement informatique à la recherche de structures innovantes en passant par l'enseignement, j'ai transformé chaque passion en compétence professionnelle. Motivé par les défis techniques et l'innovation durable, je suis aujourd’hui enthousiaste à l'idée de faire de la recherche mon métier.    <br><br>
